...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const supportBtn = document.getElementById('support-btn');
        ...
        supportBtn.addEventListener('click', () => {
            // Change this link to your Ko-fi, BuyMeACoffee, or GitHub Sponsors
            window.open('https://ko-fi.com/mariereine', '_blank');
        });
    }
    ...
    if (supportBtn) {
        supportBtn.addEventListener('click', () => {
            // Change this link to your donation page (Ko-fi, BuyMeACoffee, etc.)
            window.open('https://ko-fi.com/mariereine', '_blank');
        });
    }
